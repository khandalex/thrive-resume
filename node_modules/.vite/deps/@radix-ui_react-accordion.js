...
var Slot2 = React13.forwardRef((props, forwardedRef) => {
  const { children, ...slotProps } = props;
  ...
  if (slottable) {
    ...
    return (0, import_jsx_runtime6.jsx)(SlotClone2, { ...slotProps, ref: forwardedRef, children: React13.isValidElement(newElement) ? React13.cloneElement(newElement, void 0, newChildren) : null });
  }
  return (0, import_jsx_runtime6.jsx)(SlotClone2, { ...slotProps, ref: forwardedRef, children });
});
Slot2.displayName = "Slot";
var SlotClone2 = React13.forwardRef((props, forwardedRef) => {
  const { children, ...slotProps } = props;
...
function isSlottable2(child) {
  return React13.isValidElement(child) && child.type === Slottable2;
}
...
// node_modules/@radix-ui/react-accordion/node_modules/@radix-ui/react-id/dist/index.mjs
var useReactId2 = React19["useId".toString()] || (() => void 0);
var count2 = 0;
